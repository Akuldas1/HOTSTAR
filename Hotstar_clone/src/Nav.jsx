    ...
    <>
      <div className='nav bg-transparent h-screen w-28 z-10 fixed'>
        ...
        <div className='nav-items flex flex-col justify-center items-center gap-10 hover:opacity-1'>
          <div className='nav-ite text-white flex relative hover:opacity-1 fill-gray-500 hover:fill-white'>
            ...
            <p className='absolute opacity-0 hover:flex left-11 hover:scale-110 '>My Space</p>
          </div>
