...
function Nav() {
  return (
    <>
      <div className='nav bg-transparent h-screen w-28 z-10 fixed'>
        <div className='img my-8 mx-6 flex flex-col gap-2'>
          ...
          <div>
            <button type="button" className='text-yellow-400 bg-zinc-700 rounded-full text-xs p'>Subscribe - </button>
          </div>
        </div>

        <div className='nav-items flex flex-col justify-center items-center gap-10 hover:opacity-1'>
          <div className='nav-ite text-white flex relative hover:opacity-1 fill-gray-500 hover:fill-white hover:scale-110'>
            ...
            <p className='absolute opacity-0 hover:flex left-11  '>My Space</p>
          </div>
          ...
          <div className='nav-ite text-white'>
