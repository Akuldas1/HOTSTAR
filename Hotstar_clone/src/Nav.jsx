  ...
  return (
    <>
      <div className='nav bg-transparent h-screen w-28 z-10 fixed'>
        ...
        <div className='nav-items flex flex-col justify-center items-center gap-10'>
          <div className='text-white flex relative hover:opacity-1 fill-gray-500 hover:fill-white hover:scale-110'>
