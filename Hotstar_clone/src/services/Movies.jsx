...
//   const [horrorMovies, setHorrorMovies] = useState([]);
//   const [comedyMovies, setComedyMovies] = useState([]);
//   const horrorIndex = useRef(0);
//   const comedyIndex = useRef(0);
//   const hoveredMovie = useRef(null);
...
//   const handleHorrorNext = () => {
//     horrorIndex.current = (horrorIndex.current + 6) % Math.max(0, horrorMovies.length - 6);
//   };

//   const handleHorrorPrev = () => {
//     horrorIndex.current = horrorIndex.current === 0 ? Math.max(0, horrorMovies.length - 6) : horrorIndex.current - 1;
//   };

//   const handleComedyNext = () => {
//     comedyIndex.current = (comedyIndex.current + 6) % Math.max(0, comedyMovies.length - 6);
//   };

//   const handleComedyPrev = () => {
//     comedyIndex.current = comedyIndex.current === 0 ? Math.max(0, comedyMovies.length - 6) : comedyIndex.current - 1;
//   };
...
//           <p className='text-blue-100 font-semibold text-xl font-body'>Horror Movies</p>
//           <div className="movie-list flex gap-4 w-full">
//             <button className="arrow-btn left-arrow p-2 text-white z-10 w-10" onClick={handleHorrorPrev}>
//               <IoIosArrowBack className='text-2xl' />
//             </button>
//             {horrorMovies.slice(horrorIndex.current, horrorIndex.current + 8).map((movie, index) => (
//               <div
//                 key={movie.id}
//                 className="movie-slide"
//                 onMouseEnter={() => hoveredMovie.current = movie}
//                 onMouseLeave={() => hoveredMovie.current = null}
//               >
//                 <img
//                   src={movie.posterURL}
//                   alt={movie.title}
...
//               </div>
//             ))}
//             <button className="arrow-btn right-arrow text-white" onClick={handleHorrorNext}>
//               <IoIosArrowForward className='arrow text-2xl h-full w-full relative bg-gradient-to-l from-black' />
//             </button>
//           </div>
//         </div>
...
//           <p className='text-blue-100 font-semibold text-xl font-body'>Comedy Movies</p>
//           <div className="movie-list flex gap-4 w-full">
//             <button className="arrow-btn left-arrow p-2 text-white z-10 w-10" onClick={handleComedyPrev}>
//               <IoIosArrowBack className='text-2xl' />
//             </button>
//             {comedyMovies.slice(comedyIndex.current, comedyIndex.current + 8).map((movie) => (
//               <div
//                 key={movie.id}
//                 className="movie-slide"
//                 onMouseEnter={() => hoveredMovie.current = movie}
...
//               </div>
//             ))}
//             <button className="arrow-btn right-arrow text-white" onClick={handleComedyNext}>
//               <IoIosArrowForward className='arrow text-2xl h-full w-full relative bg-gradient-to-l from-black' />
//             </button>
//           </div>
//         </div>
