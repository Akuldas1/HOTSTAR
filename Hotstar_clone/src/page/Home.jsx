  ...
  return (
    <>
      <div className='video h-2/3'>
        ...
        <ul className='text-white flex gap-4 absolute left-28 top-1/3 font-body font-bold laptops: flex gap-2'>
          <li>2023 </li>
        ...
        <br></br><br></br>
        <div className='desc'>
        <p className='text-gray-300 absolute left-28 top-64 w-1/3 font-body laptops:absolute top-72'>Every fight begins with a failure! Braving against the odds, Manoj Kumar Sharma puts it all on the line to crack the nation’s much sought-after exam: UPSC.</p>
        <p className='crm text-white absolute left-28  font-semibold font-body laptops:absolute top-96'>Biopic &nbsp; |&nbsp; Common-Man Struggles &nbsp; | &nbsp; Underdog &nbsp; | &nbsp; Thought-provoking</p>
        </div>
        <div className=''>
         <button type='button' className='subscribe text-white text-xl font-bold absolute left-28  px-8 py-3.5 rounded-xl font-body laptops: mt-14'> Subscribe to watch</button> 
          <button type='button' className='plus text-white font-bold text-lg absolute px-6 py-3.5 rounded-xl laptops: mt-14'>+</button>
        </div>
