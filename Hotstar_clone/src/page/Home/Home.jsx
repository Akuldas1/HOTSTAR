...
function Home() {
  ...
  return (
    <>
      ...
      <div className='video h-2/3'>
        <img src={movieInfo.src} className='absolute left-28 top-10'></img>
        <ul className='text-white flex gap-4 absolute left-28 top-60 font-body font-bold mobiles:w-5 mobiles:flex mobiles:gap-2 tablets:w-6 tablets:flex tablets:gap-3 laptops:w-full'>
        ...
        <br></br><br></br>
        <div className='desc mobiles:hidden tablets:block laptops:block desktop:hidden'>
          <p className='text-gray-300 absolute left-28 top-72 w-1/3 font-body'>{movieInfo.description}</p>
          <p className='text-white absolute top-96 left-28  font-semibold font-body'>{movieInfo.genre}</p>
        </div>
