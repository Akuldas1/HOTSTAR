...
//   const goToNextHorrorMovie = () => {
//     horrorIndexRef.current = (horrorIndexRef.current + 6) % Math.max(0, horrorMovies.length - 6);
//   };

//   const goToPrevHorrorMovie = () => {
//     horrorIndexRef.current =
//       horrorIndexRef.current === 0 ? Math.max(0, horrorMovies.length - 6) : horrorIndexRef.current - 1;
//   };
...
//   return (
//     <div className='genre-container flex flex-col gap-1 relative left-28'>
//       <div className="movie-list flex gap-4 w-full">
//         <button className="arrow-btn left-arrow p-2 text-white z-10 w-10" onClick={goToPrevHorrorMovie}>
//           <IoIosArrowBack className='text-2xl' />
//         </button>
//         {horrorMovies.slice(horrorIndexRef.current, horrorIndexRef.current + 8).map((movie, index) => (
//           <div
//             key={movie.id}
//             className="movie-slide"
