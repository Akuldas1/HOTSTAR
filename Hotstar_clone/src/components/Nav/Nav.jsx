...
//             <p className='absolute opacity-0 hover:flex left-11'><button>Favourites</button></p>
//           </div>
//         </div>
//       </div>
//     </>
...
//           <div className='nav-ite text-gray-400 hover:text-white flex relative hover:opacity-1 fill-gray-500 hover:fill-white hover:scale-110' onClick={toggleModal}>
//             <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m354-287 126-76 126 77-33-144 111-96-146-13-58-136-58 135-146 13 111 97-33 143ZM233-120l65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Zm247-350Z" /></svg>
//             <p className='absolute opacity-0 hover:flex left-11'><button className='nav-fav'>Favourites</button></p>
//           </div>
//         </div>
//       </div>
...
// import { FaGreaterThan } from 'react-icons/fa';
// import { Link } from 'react-router-dom';
// import { useFavorites } from '../Favourite/FavoriteMoviesContext'; // Import useFavorites hook

// function Nav() {
//   const { favoritesCount } = useFavorites(); // Retrieve favorites count
...
//             <p className='absolute opacity-0 hover:flex left-11'>Favourite </p> 
//             <p className='fav-count'>
//             {/* <p className='fav-count opacity-0 hover:opacity-100'> */}
//             {favoritesCount}
//             </p>
//           </div>
//         </div>
...
function Nav() {
  const { favorites, favoritesCount, addToFavorites, removeFromFavorites } = useFavorites();
  ...
  return (
    <>
      ...
      <div className='nav bg-transparent h-screen w-28 z-10 fixed my-2'>
        ...
        <div className='nav-items justify-center items-center flex flex-col gap-10 my-11 font-bold z'>
          <div className='nav-ite text-gray-400 hover:text-white flex relative hover:opacity-1 fill-gray-500 hover:fill-white hover:scale-110' onClick={handleFavoriteClick}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d="m354-287 126-76 126 77-33-144 111-96-146-13-58-136-58 135-146 13 111 97-33 143ZM233-120l65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Zm247-350Z" /></svg>
            <p className='absolute opacity-0 hover:flex left-11'>Favorites</p>
            <p className='fav-count'>{favoritesCount}</p>
          </div>
